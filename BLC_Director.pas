...
var
 value : String;
begin
  value := Format('X:%.2f', [FormDemo.GetCameraStats().Position.X]);
  CamX.Caption := value;
  value := Format('Y:%.2f', [FormDemo.GetCameraStats().Position.Y]);
  CamY.Caption := value;
  value := Format('Z:%.2f', [FormDemo.GetCameraStats().Position.Z]);
  CamZ.Caption := value;
  value := Format('Dir:%.2f', [FormDemo.GetCameraStats().Rotation.Y]);
